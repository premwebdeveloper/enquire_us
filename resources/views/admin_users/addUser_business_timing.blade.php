    ...
    // Copy timing from monday to sunday shift 1
        ...
        $(".hour_operation").click(function(){
            ...
            if(hour == 1){
                ...
                $('select[class="time_0"] option[value="closed"]').prop("selected", true);
                $('select[id="time_0"] option[value="closed"]').prop("selected", true);
            }
            else{
                $(".time_0").attr("disabled", true);
                $(".open").removeAttr('checked', true);
            }
        });
                        ...
                        <div class="tabs-container">
                            ...
                            @if(!empty($user_details->user_id))
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active"><a href="{{ route($business_timing_link, ['user_id' => $user_details->user_id]) }}">Business Timing</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <form action="{{ route($user_business_timing, ['user_id' => $user_details->user_id]) }}" method="post" class="form-horizontal">
                                    {{ csrf_field() }}
                                    <fieldset>
                                    ...
                                    <div class="controls">
                                        ...
                                        foreach ($other as $key => $time)
                                        {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="checkbox" value="{{$time->working_status}}" name="other" id="close_{{$i}}" class="open closed <?= $timing_closed; ?>" <?= $checked; ?>> <label for="Name" class="control-label">Closed</label>
                                                </div>
                                                </div>
                                                <?php
