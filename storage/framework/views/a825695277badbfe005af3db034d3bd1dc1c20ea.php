...
<!-- 
    ...
    <link href="<?php echo e(asset('resources/frontend_assets/css/bootstrap-social.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('resources/frontend_assets/css/bootstrap-checkbox.css')); ?>" rel="stylesheet">

    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?php echo e(asset('resources/frontend_assets/css/custom_new.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('resources/frontend_assets/css/theme.css')); ?>" rel="stylesheet">

    <link href="<?php echo e(asset('resources/frontend_assets/js/nivo-slider/nivo-slider.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('resources/frontend_assets/js/nivo-slider/themes/default/default.css')); ?>" rel="stylesheet">

    <link href="<?php echo e(asset('resources/frontend_assets/css/lightslider.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('resources/frontend_assets/js/fancybox/jquery.fancybox.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('resources/frontend_assets/js/owlcarousel/assets/owl.carousel.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset ('resources/frontend_assets/css/validationEngine.jquery.css')); ?>" rel="stylesheet" />
        ...
        $(document).ready(function(){
            ...
            $("#filter_title").autocomplete({
                ...
                source: function( request, response ) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('searchCategoriesAndCompanies')); ?>",
                        dataType: "json",
                        data: {
                            term : request.term,
                        },
            ...
            $(document).on('click', '#search-filter', function(){
                ...
                else
                {
                    ...
                    $.ajax({
                        method : 'post',
                        url: "<?php echo e(route('getPageUrl')); ?>",
                        async : true,
                        data : {"_token": "<?php echo e(csrf_token()); ?>", 'filter_title_attr' : filter_title_alt, 'location' : location, 'sub_location' : sub_location},
                        success:function(response){
							...
							else
							{
                                ...
                                //window.location.href = "<?php echo e(url('filter')); ?>"+"/"+loc_name+"/" +response+"/" +encoded;
								window.location.href = "<?php echo e(url('/')); ?>"+"/"+loc_name+"/" +response+"/" +encoded;
							}
                        },
                        error: function(data){
                            console.log(data);
            ...
            $(document).on('click', '.cat_ies', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('getPageUrl')); ?>",
                    async : true,
                    data : {"_token": "<?php echo e(csrf_token()); ?>", 'filter_title_attr' : cat_id_identity, 'location' : location},
                    success:function(response){
            ...
            $(document).on('click', '.sub_cat_ies', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('getPageUrl')); ?>",
                    async : true,
                    data : {"_token": "<?php echo e(csrf_token()); ?>", 'filter_title_attr' : sub_cat_id_identity, 'location' : location},
                    success:function(response){
            ...
            $(document).on('click', '.client_view_details', function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('getPageUrl')); ?>",
                    async : true,
                    data : {"_token": "<?php echo e(csrf_token()); ?>", 'filter_title_attr' : client_id_identity, 'location' : location},
                    success:function(response){
