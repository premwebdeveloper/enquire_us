	...
	<div class="container">
		<div class="row">
            ...
            <div class="col-sm-12 banner-slider">
                <div class="row">
                    <?php $s = 6; $l = 11; ?>
                    <?php for($i = 1; $i < count($super_catgory); $i++): ?>
                                    
                        <div class="col-sm-2">
                            <div class="row">
                                <div class="col-lg-12 res-catagories text-center">
                                    <a href="<?php echo e(route('categories', ['super_cat_id' => $super_catgory[$i]->id])); ?>" class="list-group-item super_caties">                                       
                                        <img src="storage/app/uploads/super_category/<?php echo e($super_catgory[$i]->image); ?>" alt="<?php echo e($super_catgory[$i]->name); ?>" width="150" />
                                        <br>
                                        <?php echo e($super_catgory[$i]->name); ?>
