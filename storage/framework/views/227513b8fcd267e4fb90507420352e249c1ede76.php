        ...
        <div class="container">
          ...
          <div class="row">
                <div class="col-sm-12 subscribe">
                    ...
                    <?php if(session('subscribe')): ?>
                        <div class="col-md-12">
                            <div class="alert alert-success alert-dismissible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <?php echo e(session('subscribe')); ?>
                ...
                <div class="col-lg-9 col-sm-offset-3">
                    <form action="<?php echo e(route('subscribers')); ?>" method="post" id="subscribe">
      	...
      	<div class="container">
          	<div class="row">
            	...
            	<div class="col-sm-4">
              	<div class="footer-logo">
                	<img alt="Footer-logo" src="<?php echo e(url('/')); ?>/resources/frontend_assets/images/logo.png" />
                </div>
            ...
            <div class="col-sm-2">
                <div class="footer-menu">
                    ...
                    <ul>
                        ...
                        <?php $__currentLoopData = $website_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $page_name = preg_replace('/[^A-Za-z0-9\-]/', '-', $pages->page_title);
                            ?>
                            <li><a href="<?php echo e(URL::to('webpage',array('webpage'=>$page_name))); ?>"><?php echo e($pages->page_title); ?></a></li>
            ...
            <div class="col-sm-2">
                <div class="footer-menu">
                  <h3>Merchants</h3>
                    <ul>
                        <li><a href="<?php echo e(route('login')); ?>">Merchant Signin</a></li>
                        <li><a href="<?php echo e(route('register')); ?>">Merchant Signup</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="apps">
                  <a href="#">
                    <img class="img-responsive" alt="" src="<?php echo e(url('/')); ?>/resources/frontend_assets/images/play-store.png" />
                  </a>
                </div>
                <div class="copyright">
